		...
		<div className="container mx-auto p-6 space-y-6">
			...
			<div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
				<div>
					...
					<p className="text-muted-foreground mt-1">Real-time voting analytics and insights</p>
				</div>
				...
				<CardContent>
					{trendData.every((d) => d.votes === 0) ? (
						<div className="text-center py-12">
							...
							<p className="text-muted-foreground">No votes have been cast in the last 7 days</p>
						</div>
					) : (
						<div className="space-y-4">
							...
							<div className="text-center text-sm text-muted-foreground">Daily vote counts over the past week</div>
						</div>
					)}
				</CardContent>
			</Card>
				...
				<CardContent>
					<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
						<div className="space-y-2">
							...
							<Progress
								value={elections.length > 0 ? (getElectionsByStatus("draft").length / elections.length) * 100 : 0}
							/>
						</div>
						...
						<div className="space-y-2">
							...
							<Progress
								value={elections.length > 0 ? (getElectionsByStatus("active").length / elections.length) * 100 : 0}
							/>
						</div>
						...
						<div className="space-y-2">
							...
							<Progress
								value={elections.length > 0 ? (getElectionsByStatus("completed").length / elections.length) * 100 : 0}
							/>
						</div>
						...
						<div className="space-y-2">
							...
							<Progress
								value={elections.length > 0 ? (getElectionsByStatus("cancelled").length / elections.length) * 100 : 0}
							/>
						</div>
					</div>
				</CardContent>
